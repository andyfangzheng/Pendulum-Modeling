% this is the file you use to submit your solutions to the grading server
% do not modify this file
% run this after you have implemented getTorque.m

function submit()

  disp('Submit solutions for Homework 5')
  ...
  disp('Connecting to grading server and submitting ...')
  
  submitSolution(login, sha1(password), source());
  
end

% ================== configurations ==================

function name = homework_name() 
  name = 'Pendulum';
end

function src = source()
    src = evalc('type getTorque.m');
end

function url = submit_url()
  url = 'http://students.washington.edu/yuangao/amath383spr2015/submit/';
end

% ========================= subimt helpers =========================

function submitSolution(login, password, source)
  ...
  response = urlread(submit_url(), 'post', params);
